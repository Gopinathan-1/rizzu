  ...
  return (
    <View className="gap-5">
      <View className="relative overflow-hidden rounded-[30px] px-1 py-2">
        <View className="absolute -left-8 top-0 h-32 w-32 rounded-full bg-violet-500/15 blur-3xl" />
        <View className="absolute -right-10 top-2 h-32 w-32 rounded-full bg-sky-500/10 blur-3xl" />

        <View className="relative gap-4">
          <LinearGradient
            colors={['rgba(124,58,237,0.96)', 'rgba(59,130,246,0.92)']}
            start={{ x: 0, y: 0.5 }}
            end={{ x: 1, y: 0.5 }}
            className="self-start rounded-full px-4 py-2 shadow-lg shadow-violet-500/20"
          >
            <Text size="sm" weight="bold" className="text-white tracking-tight">
              {analysis.tone}
            </Text>
          </LinearGradient>

          <View className="gap-2">
            <Text variant="headline" className="text-[28px] leading-8 tracking-tight text-white">
              {heading}
            </Text>
            <Text className="max-w-[340px] text-[15px] leading-6 text-white/65">
      ...
      <View className="gap-3">
        <Text size="xs" className="pl-1 uppercase tracking-[0.35em] text-white/35">
          Suggested replies
        </Text>
